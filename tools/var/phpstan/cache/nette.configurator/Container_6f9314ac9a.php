...
class Container_6f9314ac9a extends _PHPStan_3bfe2e67c\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService042(): PHPStan\Analyser\ResultCache\ResultCacheManagerFactory
	{
		return new class ($this) implements PHPStan\Analyser\ResultCache\ResultCacheManagerFactory {
			...
			public function __construct(Container_6f9314ac9a $container)
			{
	...
	public function createService056(): PHPStan\DependencyInjection\DerivativeContainerFactory
	{
		return new PHPStan\DependencyInjection\DerivativeContainerFactory(
			...
			['phar:///var/www/bin/phpstan/conf/config.level8.neon', '/var/www/tools/linter/phpstan.neon'],
			$this->parameters['analysedPaths'],
			['/var/www'],
	...
	public function createServiceContainer(): Container_6f9314ac9a
	{
		return $this;
	}
